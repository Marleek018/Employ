...
const Subhero = () => {
  return (
    <div>
      <div className="  xs:block xmd:flex justify-between xs:px-[12px] xsm:px-[34px] xmd:px-[88px] xs:py-[55px] xmd:py-[168px] bg-fgray font-DmSans">
        <div>
          ...
          <h3 className=" font-semibold xs:text-center xmd:text-left xs:text-[28px] xsm:text-[34px] xmd:text-[60px] xs:leading-[39px] xsm:leading-[46px] xmd:leading-[78px] xs:pb-[72px] xmd:pb-[52px]">
          ...
          <div className="relative xs:visible xmd:invisible">
            <img
              className="absolute xs:right-[0%] xsm:right-[0%] xs:top-[-50px]"
              src={mobilevec}
              alt="IMAGE"
            />
          </div>
        ...
        <div className="xs:mt-[78px] xmd:mt-0">
          <div className="xs:w-[363px] xsm:w-[410px]  xmd:w-[444px] xs:h-[140px] xsm:h-[160px] xmd:h-fit flex gap-[11px] bg-newwhite border-[0.5px] border-jgray rounded-[12px] xs:p-[16px]  xmd:p-[20px] mb-[19px]">
            <img
