...
const Values = () => {
  return (
    <section className="bg-dgray xs:pt-[] xsm:pt-[] xmd:pt-[189px] xs:pb-[] xsm:pb-[] xmd:pb-[200px]">
      ...
      <div className="xmd:flex xmd:justify-center xmd:gap-[18px]">
        <div className="border-[1px] border-jgray rounded-[12px] xs:w-[293px] xmd:w-[270px] h-fit  px-[27px] pt-[35px] pb-[25px]">
          <div className="flex justify-center">
        ...
        <div className="border-[1px] border-jgray rounded-[12px] xs:w-[293px] xmd:w-[270px] h-fit  px-[32px] pt-[28px] pb-[33px]">
          <div className="flex justify-center">
        ...
        <div className="border-[1px] border-jgray rounded-[12px] xs:w-[293px] xmd:w-[270px] h-fit  px-[48px] pt-[28px] pb-[33px]">
          <div className="flex justify-center">
